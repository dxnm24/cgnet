<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    ...
    @foreach(CommonQuery::getAllWithStatus('game_types') as $value)
    <?php 
    ...
    @endforeach
    @foreach(CommonQuery::getAllWithStatus('game_tags') as $value)
    <url>
    ...
    @endforeach
    @foreach(CommonQuery::getAllWithStatus('games') as $value)
	    <url>
